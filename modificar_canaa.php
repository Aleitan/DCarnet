...
<a href="components.html" class="btn btn-primary btn-component" data-spy="affix" data-offset-top="600"><i class="ti-shift-left-alt"></i> Components</a>
    ...
    <?php
        ...
        $result = select_id("cana_aca", "id", $_GET['id']);
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-4 about-card">
                ...
                <form id="form" name="form" action="actualizar_canaa.php" method="post">
                    ...
                    <div>
                        ...
                        <input type="text" name="txt_N" id="txt_N" value="<?php echo $row->nombr; ?>" required>
                    </div>

                    <div>
                        <label for="txt_ctr">Numero de Control: </label><br>
                        <input type="text" name="txt_ctr" id="txt_ctr" value="<?php echo $row->noc; ?>" required>
                    </div>
                   
                    <div>
                    <label for="txt_a">Asesor: </label><br>
                    <input type="text" name="txt_a" id="txt_a" value="<?php echo $row->asesor; ?>" required>
                    </div>
                   
                    <div>
                    <label for="txt_as">Asignatura: </label><br>
                    <input type="text" name="txt_as" id="txt_as" value="<?php echo $row->asignatura; ?>" required>
                    </div>

                    <div>
                    <label for="date_s">Fecha de Solicitud: </label><br>
                    <input type="date" name="date_s" id="date_s" value="<?php echo $row->fecha_s; ?>" required>
                    </div>

                    <div>
                    <label for="date_a">Fecha de Atención: </label><br>
                    <input type="date" name="date_a" id="date_a" value="<?php echo $row->fecha_a; ?>" required>
                    </div>
